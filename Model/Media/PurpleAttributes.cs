...
namespace Belet.Model.Media
{
    class PurpleAttributes
    {
       ...
       [JsonProperty("duration")]
        ...
        public TblRbCountriesClass TblRbMediaActors { get; set; }

        [JsonProperty("tbl_rb_languages")]
        public TblRbCountriesClass TblRbLanguages { get; set; }

        [JsonProperty("tbl_rb_year")]
        public TblRbMediaDirectorClass TblRbYear { get; set; }

        [JsonProperty("tbl_rb_media_director")]
        public TblRbMediaDirectorClass TblRbMediaDirector { get; set; }

        [JsonProperty("tbl_rb_countries")]
        public TblRbCountriesClass TblRbCountries { get; set; }
